...
console.log("Mensaje de str: ", str);
console.log("Tipo de variable str: ", typeof(str));
...
console.log("Valor de varible: ", change);
console.log("Tipo de variable change: ", typeof(change));

//Se cambia el tipo de variable change
change = "I've changed my type"; //Se cambia el tipo de variable a string
...
console.log("Valor de varible: ", bigIntX);
console.log("Tipo de variable bigIntX: ", typeof(bigIntX));

console.log("Valor de varible: ", bigIntY);
console.log("Tipo de variable bigIntY: ", typeof(bigIntY));

//Declaración e inicialización de una variable de tipo symbol
let sym = Symbol('&');

//Muestra del valor y tipo de la variable sym
console.log("Valor de variable: ",sym);
console.log("Tipo de variable sym: ",typeof(sym));